            ...
            <div id="page-content-wrapper">
				...
				<form action="Mypage_mem_ok.jsp" method="get">
					<table class="table table-sm">
						...
						<tr>
							<td>Email</td>
							<td><input type="text" class="form-control" name="email" placeholder="Example@naver.com"></td>
						</tr>
						<tr>
							<td>Phone</td>
							<td><input type="text" class="form-control" name="phone" placeholder="000-0000-0000"></td>
						</tr>
						<tr>
							<td>Addrs</td>
							<td>
								<input type="text" class="form-control" id="post" size="7"/>
								<input type="button" id="btn" value="우편번호찾기"/>
								<input type="text" class="form-control" id="addrs" size="30"/>
							</td>
						</tr>
					</table>
