...
<body style="padding-top: 40px;">
	<div class="card align-middle" style="width: 25rem;">
		<div class="title">
			<a href="main.jsp"><img alt="" src="../images/logo.jpg"
				class="title"></a> <br />
		</div>
		...
		<form action="loginOk.jsp" class="login" name="frm" method="post">
			<div class="checkbox">
				<label> <input type="radio" name="mode" value="admin">
					관리자 &nbsp;&nbsp; <input type="radio" name="mode" value="user"
					checked> 일반회원
				</label>
			</div>
			...
			<div class="card-body" style="text-align: center">
				<input type="text" name="id" id="id" class="form-control"
					...
					name="pwd" id="pwd" class="form-control" placeholder="비밀번호"
					required><br>
				<p class="check" id="check" style="text-aling: left">${check}</p>
				<input type="checkbox" name="autoid" id="autoid" /> 자동로그인 <input
					type="checkbox" name="saveid" id="saveid" /> 아이디저장 <br />
				<br /> <input id="btn-login"
