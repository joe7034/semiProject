...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="">재고관리</a>
            <!-- Sidebar Toggle-->
				...
				<table class="table table-striped">
					...
					<tr>
						<form action="StockManageOK.jsp" method="get">
							...
							<td><%=vo.getSell() %></td>
							<td><%=vo.getStock() %></td>
							<td><input type="text" name="addstock" value="0"/></td>
							<input type="hidden" value="<%=vo.getPno() %>" name="pno"/>
							<input type="hidden" value="<%=vo.getStock() %>" name="nowstock"/>
